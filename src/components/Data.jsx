...
/** * ====================================================================
 * @project     Analisis Kompleksitas Algoritma: Iteratif vs Rekursif
 * @author      Anugrah Panji Pradipa
 * @description Watermarked Source Code - AKA Project 2025
 * ====================================================================
 */
...
const Data = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans text-slate-900 relative">
      <div className="max-w-6xl mx-auto space-y-8">
                      ...
                      >
                        ...
                        <td className="py-4 px-4 text-right">
                          <button
                            ...
                            className={`px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-wider transition ${
        ...
        {averageData && (
          <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500">
            <div className="bg-gradient-to-r from-indigo-600 to-indigo-800 text-white p-8 rounded-[2rem] shadow-xl">
        ...
        {/* --- WATERMARK FOOTER --- */}
        <footer className="mt-16 pt-8 border-t border-slate-200 text-center pb-8">
          <div className="flex flex-col items-center gap-3">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">© 2025 ANALISIS KOMPLEKSITAS ALGORITMA</p>
            <p className="text-sm font-medium text-slate-600">
              Developed & Coded by <span className="text-indigo-600 font-black">ANUGRAH PANJI PRADIPA</span>
            </p>
            <div className="flex gap-4 mt-2">
              <a
                href="https://github.com/anugrahpanjipradipa"
                target="_blank"
                rel="noreferrer"
                className="text-[9px] font-bold bg-slate-900 text-white px-4 py-1.5 rounded-full hover:bg-indigo-600 transition tracking-widest"
              >
                GITHUB PROFILE
              </a>
            </div>
      ...
      {/* WATERMARK TEKS HALUS (DECORATIVE) */}
      <div className="fixed bottom-10 right-[-50px] pointer-events-none select-none hidden lg:block rotate-90">
        <p className="text-[10px] font-mono text-slate-200 font-bold tracking-[1em] uppercase opacity-50">ANUGRAH PANJI PRADIPA • AKA PROJECT</p>
      </div>
    </div>
  );
};
